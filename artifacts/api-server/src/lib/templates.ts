    ...
    build: (context) =>
      withWatermark(
        [
          ...
          { type: "normalizeLoudness", targetLufs: -13, voice: true, denoise: true },
        ],
        context,
      ),
  },
    ...
    build: (context) =>
      withWatermark(
        [
          ...
          { type: "normalizeLoudness", targetLufs: -14, voice: false, denoise: false },
        ],
        context,
      ),
  },
    ...
    build: (context) =>
      withWatermark(
        [
          ...
          { type: "normalizeLoudness", targetLufs: -13, voice: false, denoise: false },
        ],
        context,
      ),
  },

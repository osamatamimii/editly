...
const AREA_PURPOSE = {
  ...
  "media.ts": "إذن القراءة: رابط موقَّع لملفٍّ يملكه صاحبه، أو تنزيل باسمه",
  "promo.ts": "رمز يُكتب فيُمنح خطّة — لا خصم، بل غياب دفعة",
  "notes.ts": "ملاحظات المشروع ونصّه المكتوب",
  ...
  "product-ads.ts": "إعلان منتج: صور ومنتج واسم وسعر يصير فيديو",
};

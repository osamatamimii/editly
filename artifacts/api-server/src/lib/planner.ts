...
function instructionFor(assets: PlannerAsset[]): string {
  ...
  const lines = [
    ...
    "wipeLeft, wipeRight, wipeUp, wipeDown, softWipeLeft, softWipeRight, softWipeUp, softWipeDown, slideLeft,",
    "slideRight, slideUp, slideDown, flash, flashBlack,",
    ...
    "The softWipe four are the same four directions with the edge feathered into a gradient instead of a hard",
    "line. Prefer them whenever somebody asks for a wipe without saying what its edge should be: a hard line",
    "crossing the frame is the one shape in this list that reads as slideshow software. Use the plain wipe four",
    "only when they say hard edge, hard wipe or sharp wipe.",
    ...
    "Never choose a wipe, a slide, zoomBlur or glitch unless they ask for that shape by name: an automatic wipe",
    "is the look of a slideshow and a glitch nobody asked for reads as a real fault in the video. Choosing for",
    "somebody claims to know a thing about their taste that nothing in the recording could have told you. The",
    "three you may choose on your own are dissolve, whipPan for a montage cut to music on a vertical feed, and",
    "flashBlack between the sections of a long conversation.",

  ...
  },
  {
    ...
    */
    ...
    label: say(
      ...
      "أنشرها على حساباتك لسا، والناقص اعتماد مش كود. الجدولة مبنيّة والإرسال كمان: ليوتيوب وتيك توك وريلز إنستغرام وصفحات فيسبوك و‏X في رافع شغّال هون. وكل وحدة من هالمنصّات بتراجع التطبيق قبل ما تسمح له ينشر بدال حدا، وما خلصت ولا مراجعة منها لسا",
    ),
  },
  {
    /*

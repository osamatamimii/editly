...
const DialogFooter = ({
  ...
  <div
    className={cn(
      // `space-x-reverse` under RTL, or the gap Tailwind puts between these
      // buttons lands on the wrong side of each and the row reads as one
      // button crowded against the next.

...
const XFADE_STYLE: Record<TransitionStyle, string> = {
  ...
  slideUp: "slideup",
  slideDown: "slidedown",
  // ffmpeg calls the feathered wipes `smooth*`, which is a name about how the
  // edge is drawn rather than about what the join is. Ours says what it is.
  softWipeLeft: "smoothleft",
  softWipeRight: "smoothright",
  softWipeUp: "smoothup",
  softWipeDown: "smoothdown",
  flash: "fadewhite",
